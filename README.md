...
> **Note**
> Everywhere in this repository, make sure to replace `sukarn-m/sukarn-ublue` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
